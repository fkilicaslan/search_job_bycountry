...
<!-- ============================================================
     ...
     HOW TO SET UP:
       Option A (recommended):
         ...
         The wizard writes config/profile.yml, cv.md, portals.yml,
         and creates a copy of this file as modes/_profile.md.
       
       Option B (manual):
         Copy this file: cp modes/_profile.template.md modes/_profile.md
