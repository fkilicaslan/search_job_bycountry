...
7. **Claim use of a specific tool, platform, or product unless it appears verbatim in cv.md or the Career Story source documents (`C:\Users\Fatih\Desktop\May2026\Fatih Documents\13102025\Job Application Folders\Career Story\`). This includes: never claiming use of the target company's own platform (e.g. "used Arize AI", "Mistral API", "Glean") based solely on a batch evaluation report recommendation. Evaluation report suggestions are recommendations TO the candidate, not verified facts.**
