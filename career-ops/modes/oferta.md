...
**Step 1 — Load context**
Read `data/corpus/narrative/interview-stories.md` for pre-built answers and named client stories.
Read `data/corpus/narrative/leadership-philosophy.md` for leadership one-liners and story hooks.
Check `interview-prep/story-bank.md` if it exists.

**Step 2 — Map 6–10 STAR+R stories to this JD's specific requirements**

Each story must come from real experience in the candidate's profile. No fabrication.
The **Reflection** column signals seniority — describe what was learned or what would be done differently.

| # | JD Requirement | Story (company + situation) | S | T | A | R | Reflection |
|---|----------------|----------------------------|---|---|---|---|------------|
| 1 | {req from JD}  | {client/deal reference}     | … | … | … | … | … |

Where possible, reuse pre-built stories from `data/corpus/narrative/interview-stories.md` (Akbank, Turkcell, Borusan, Raynet, beqom/Garanti etc.) — adapt framing to match the specific JD requirement.

If a story is missing (no match in context docs), write a skeleton and mark: *"Fill in your specific numbers/details."*

**Step 3 — Archetype framing** (select emphasis based on role type):
- **Enterprise AE / Sales Director** → emphasize new logo acquisition, competitive displacement, quota attainment, multi-stakeholder cycles, C-level trust-building
- **CSM / Success Manager** → emphasize retention, expansion, consumption growth, pilot success criteria, stakeholder alignment post-sale
- **BD / Partnerships** → emphasize co-sell motions, alliance building, partner ecosystem development, joint GTM
- **Pre-Sales / Solutions** → emphasize technical credibility, demo design, pilot architecture, discovery workshops
- **Sales Leader / Director** → emphasize team building, pipeline methodology, P&L ownership, succession planning
- **FDE / Transformation** → emphasize deployment quality, organizational change, adoption metrics, value realization

**Step 4 — Also include:**
- **Weakness framing** (pick the most relevant from `data/corpus/narrative/interview-stories.md` weakness section)
- **"Why this company?"** — 2–3 sentences specific to the JD's company and mission
- **Red-flag questions** and suggested responses (e.g. "Your background is Turkey — why DACH?", "You've never held a CSM title", "Why the career break?")

**Step 5 — Update Story Bank**
Append any new stories to `interview-prep/story-bank.md` (create if missing). Over time this builds a reusable master bank adaptable to any interview question.
